...
Implements a single module from an existing spec in `.cursor/dev/specs/`.
Requires spec to exist — stops otherwise.
...
1. Read `.cursor/dev/specs/$SLUG.md` — if it doesn't exist, STOP and say:
...
4. Check `.cursor/dev/lessons.md` for implementation patterns in this codebase
...
- Do NOT write to `.cursor/dev/lessons.md` yourself
