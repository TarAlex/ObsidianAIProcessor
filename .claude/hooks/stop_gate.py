...
tracker = Path("ProgressTracking/TRACKER.md")
results = Path("ProgressTracking/test-results.log")
    ...
    if not has_results:
        print(json.dumps({
            ...
            "message": (
                ...
                "ProgressTracking/test-results.log. Run pytest before calling /done."
            )
        }))
