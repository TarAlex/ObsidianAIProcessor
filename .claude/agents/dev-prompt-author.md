...
description: >
  ...
  NOT Claude Code agents. Use when a prompt file needs to be created
...
`agent/llm/prompt_loader.py` at tool runtime. You are NOT writing Claude Code agents.
...
4. Save quality observations (what local models struggle with) to project memory
